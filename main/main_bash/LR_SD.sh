...
python main/train.py -c model_setting/compare_method/LR/SD/LR_Short.py -g 0 &
python main/train.py -c model_setting/compare_method/LR/SD/LR_LN_Short.py -g 0 &
# python main/train.py -c model_setting/compare_method/LR/SD/LR_TLN_Short.py -g 0 & 
# python main/train.py -c model_setting/compare_method/LR/SD/LR_SLN_Short.py -g 0 & 
