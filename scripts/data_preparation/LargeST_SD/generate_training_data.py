...
def generate_data_all(args: argparse.Namespace):
    ...
    data_info = json.load(open(os.path.join(data_info_folder, "LargeST_SD"), "r"))
    ...
    flow_data = np.expand_dims(df.values, axis=-1)
