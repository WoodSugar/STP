...
def generate_adj_pems07():
    distance_df_filename, num_of_vertices = "dataset/PeMS07New/PEMS07.csv", 883
    ...
    with open("dataset/PeMS07New/adj_PEMS07.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("dataset/PeMS07New/PEMS07/adj_PEMS07_distance.pkl", "wb") as f:
