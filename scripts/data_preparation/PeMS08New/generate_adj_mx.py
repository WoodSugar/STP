...
def generate_adj_pems08():
    distance_df_filename, num_of_vertices = "dataset/PeMS08New/PEMS08.csv", 170
    ...
    with open("dataset/PeMS08New/adj_PEMS08.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("dataset/PeMS08New/adj_PEMS08_distance.pkl", "wb") as f:
