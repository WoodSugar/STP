...
import numpy as np
from ..common import get_uni_graph, get_idn_graph, get_ran_graph
...
adj_mx1 = np.ones_like(adj_m1) + np.random.rand(adj_m1.shape[0], adj_m1.shape[1]) * 1e-6
adj_mx = torch.tensor(adj_mx1, dtype=torch.float32)
