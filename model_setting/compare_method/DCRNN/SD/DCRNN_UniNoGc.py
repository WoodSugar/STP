...
adj_mx1 = np.ones_like(adj_m1) + np.random.rand(adj_m1.shape[0], adj_m1.shape[1]) * 0.001
adj_mx2 = np.ones_like(adj_m2) + np.random.rand(adj_m2.shape[0], adj_m2.shape[1]) * 0.001

adj_mx1 = adj_mx1.astype(np.float32)
adj_mx2 = adj_mx2.astype(np.float32)

adj_mx = [torch.tensor(adj_mx1), torch.tensor(adj_mx2)]
