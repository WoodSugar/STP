...
from compare_model.Hyper_DCRNN import HyperDCRNN
...
local_adj = get_idn_graph(num_nodes=CFG.DATASET_DESCRIBE.get("num_nodes"))
adj_mx = [local_adj, local_adj]
...
# ================= model ================= #
CFG.MODEL.NAME = "HyperDCRNN"
CFG.MODEL.ARCH = HyperDCRNN
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    "result/hyper_model/DCRNN/PeMS04",
