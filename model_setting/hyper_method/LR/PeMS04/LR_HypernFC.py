...
from main.main_arch.hypergraph import HyperNet, HyperNetnFC 
from main.main_arch.hypergraph import ConcatModel


CFG = EasyDict()

# ================= general ================= #
CFG.DESCRIPTION = "LR_HyperLearnFC model configuration"
...
CFG.TRAIN.NUM_EPOCHS = 202
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    "result/hyper_model/LR/PeMS04",
