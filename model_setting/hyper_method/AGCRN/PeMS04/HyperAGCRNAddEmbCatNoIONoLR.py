...
from compare_model.Hyper_AGCRN import HyperAGCRN
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "HyperAGCRNAddEmbCatNoIONoLR"
CFG.MODEL.ARCH = HyperAGCRN
...
CFG.MODEL.PARAM = {
    ...
    "embed_dim" : 10,
    "cheb_k"    : 2,
    "temporal_length": CFG.DATASET_INPUT_LEN, 
    "Sk": 20, 
    "Tk": 1, 
    "affine": True
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    "result/hyper_model/AGCRN/PeMS04",
