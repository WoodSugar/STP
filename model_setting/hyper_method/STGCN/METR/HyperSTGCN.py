...
import numpy as np
from ..common import get_ran_graph, get_idn_graph, get_uni_graph
from compare_model.Hyper_STGCN import HyperSTGCN
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "HyperSTGCN"
CFG.MODEL.ARCH = HyperSTGCN
