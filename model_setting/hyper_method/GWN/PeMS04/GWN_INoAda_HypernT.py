...
from basic_ts.losses import masked_mae, masked_rmse, masked_mape
...
from compare_model.BTS_GWNet import GWNet
from ..common import get_idn_graph, get_ran_graph, get_uni_graph
from main.main_arch.hypergraph import HyperNet, ConcatModel, HyperNetnT
...
# ================= general ================= #
CFG.DESCRIPTION = "GWNet model configuration"
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "GWN_INoAda_HypernT"
...
CFG.MODEL.PARAM = {
    ...
    "backbone_args" :{
        ...
        "out_dim": CFG.DATASET_OUTPUT_LEN * CFG.MODEL.OUTPUT_DIM,
