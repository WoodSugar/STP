...
from compare_model.Hyper_STSGCN_Ablation import HyperSTSGCN
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "HyperSTSGCNnFC"
CFG.MODEL.ARCH = HyperSTSGCN
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    "result/hyper_model/HyperSTSGCN/PeMS04",
