...
class STSGCN(nn.Module):
    def __init__(self, adj, history, num_of_vertices, in_dim, out_dim, hidden_dims,
                 ...
                 temporal_emb=True, spatial_emb=True, horizon=12, strides=3, affine=True, method="default"):
        """
...
class HyperSTSGCN(STSGCN):
    def __init__(self, adj, history, num_of_vertices, in_dim, out_dim, hidden_dims, first_layer_embedding_size, out_layer_dim, Sk, Tk, activation='GLU', use_mask=True, temporal_emb=True, spatial_emb=True, horizon=12, strides=3, affine=True, use_long_history=False, **model_kwargs):
        method = model_kwargs.get("method", "default")
        super().__init__(adj, history, num_of_vertices, in_dim, out_dim, hidden_dims, first_layer_embedding_size, out_layer_dim, Sk, Tk, activation, use_mask, temporal_emb, spatial_emb, horizon, strides, affine, method)
